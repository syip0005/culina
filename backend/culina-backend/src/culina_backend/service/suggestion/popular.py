"""Global popularity suggestion strategy (cold start fallback)."""
...
class PopularSuggestionStrategy:
    def __init__(self, cache_ttl: int = 3600) -> None:
        self._cache_ttl = cache_ttl
        self._cache: dict[tuple[str | None, int], tuple[float, list[UUID]]] = {}
